      seqfile = Lepidosauria.aln.faa * sequence data filename
     treefile = Notechis_scutatus.nwk      * tree structure file name
      outfile = Notechis_scutatus_F1x4_bneutral.out        * main result file name
