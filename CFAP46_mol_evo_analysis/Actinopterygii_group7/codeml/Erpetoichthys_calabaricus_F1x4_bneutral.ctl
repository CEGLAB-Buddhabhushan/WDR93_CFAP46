      seqfile = Actinopterygii_group7.aln.faa * sequence data filename
     treefile = Erpetoichthys_calabaricus.nwk      * tree structure file name
      outfile = Erpetoichthys_calabaricus_F1x4_bneutral.out        * main result file name
