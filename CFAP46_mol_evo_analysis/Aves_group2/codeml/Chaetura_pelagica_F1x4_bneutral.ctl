      seqfile = Aves_group2.aln.faa * sequence data filename
     treefile = Chaetura_pelagica.nwk      * tree structure file name
      outfile = Chaetura_pelagica_F1x4_bneutral.out        * main result file name
