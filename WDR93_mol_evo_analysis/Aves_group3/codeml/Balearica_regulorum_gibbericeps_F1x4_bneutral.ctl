      seqfile = Aves.group3.aln.faa * sequence data filename
     treefile = Balearica_regulorum_gibbericeps.nwk      * tree structure file name
      outfile = Balearica_regulorum_gibbericeps_F1x4_bneutral.out        * main result file name
