      seqfile = Chondrichthyes.aln.faa * sequence data filename
     treefile = Chiloscyllium_punctatum.nwk      * tree structure file name
      outfile = Chiloscyllium_punctatum_F1x4_bneutral.out        * main result file name
