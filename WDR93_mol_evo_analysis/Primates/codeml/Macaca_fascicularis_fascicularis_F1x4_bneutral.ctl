     ...
     treefile = Macaca_fascicularis_fascicularis.nwk      * tree structure file name
      outfile = Macaca_fascicularis_fascicularis_F1x4_bneutral.out        * main result file name
